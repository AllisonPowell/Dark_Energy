...
def main():
    ...
    parser.add_argument("--outdir", default="outputs/plots_repro")
    ...
    made.append(make_triangle(args.repro_root, args.outdir, "pantheon", color="deeppink"))

    #p_v0v1, p_frac = make_v0_v1(args.repro_root, args.outdir, "pantheon", color="deeppink")
